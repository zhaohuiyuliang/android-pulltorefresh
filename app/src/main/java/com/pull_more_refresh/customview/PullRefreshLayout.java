...
public class PullRefreshLayout extends ViewGroup {
    ...
    public static final int LARGE = MaterialProgressDrawable_.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = MaterialProgressDrawable_.DEFAULT;
    ...
    private CircleImageView_ mCircleView;
    ...
    private MaterialProgressDrawable_ mProgress;
    ...
    public void setSize(int size) {
        if (size != MaterialProgressDrawable_.LARGE && size != MaterialProgressDrawable_.DEFAULT) {
            return;
        }
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        if (size == MaterialProgressDrawable_.LARGE) {
    ...
    private void createProgressView() {
        mCircleView = new CircleImageView_(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
        mProgress = new MaterialProgressDrawable_(getContext(), this);
