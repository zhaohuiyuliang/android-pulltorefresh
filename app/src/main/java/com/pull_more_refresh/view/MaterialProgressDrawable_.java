...
public class MaterialProgressDrawable_  extends Drawable implements Animatable {
    ...
    public MaterialProgressDrawable_(Context context, View parent) {
        mParent = parent;
     ...
     *
     * @param size One of {@link MaterialProgressDrawable_.LARGE} or
     *            {@link MaterialProgressDrawable_.DEFAULT}
     */
